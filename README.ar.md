...
السيرفر وشغّله بثاً، أو اسحبه للجهاز ودع السيرفر ينظّف نفسه. ويستطيع MeTube
Super أيضاً أن **يتابع قناة**: ينزّل سيرفرك كل مقطع جديد وحده، ويخبرك التطبيق
حين يصل. مكتوبان بـFlutter في مستودع واحد، بالعربية والإنجليزية، وبرمجية حرة
برخصة GPL.

<p align="center">
  <img src="docs/screenshots/hero-ar.jpg" alt="MeTube Super: المكتبة، ومشغل الفيديو مع قائمة «التالي»، ومشغل الصوت ليلاً، وقوائم التشغيل">
</p>
...
| الحصري | خيار الاقتصار على Wi‑Fi، وتنظيف السيرفر | اشتراكات القنوات، ووسوم، وتحميل دفعي، و«إتاحة دون اتصال»، وتبديل عناوين السيرفر |
...
- **الاشتراكات**: تابع قناة أو قائمة تشغيل، فيفحصها سيرفر MeTube في مواعيد
  تختارها وينزّل كل مقطع جديد إلى المكتبة نفسها — ما يظهر من الآن فقط، لا أرشيف
  القناة. أوقفها مؤقتاً، أو أعد تسميتها، أو افحصها فوراً، أو اقصرها على عناوين
  تحوي كلمة. وإشعار واحد لكل دفعة تصل، يظهر حين يتصل التطبيق بالسيرفر. تحتاج
  نسخة MeTube حديثة تدعم الاشتراكات، ومع الأقدم منها يقول التطبيق ذلك صراحة.
- **الكوكيز من الجوال** للمواقع التي تطلب تسجيل دخول: اختر الملفات المصدَّرة
  من متصفحك، لعدة منصات معاً، فتُدمج في الملف الواحد الذي يحفظه السيرفر.
...
**الاشتراكات** — القنوات التي يتابعها سيرفرك، ومتابعة قناة جديدة، والإشعار حين
تصل مقاطعها:

![قائمة الاشتراكات، وورقة المتابعة، وإشعار الوصول](docs/screenshots/subscriptions.jpg)
...
كل إصدار يحمل ملفاً لكل تطبيق —
[أحدثها هنا](https://github.com/sagheerys/metube-mobile/releases/latest)،
والشارة في الأعلى تذكر رقمه. الملف `MeTube-Lite-<الإصدار>.apk` لنسخة العائلة
والأصدقاء، و`MeTube-Super-<الإصدار>.apk` لنسخة مالك السيرفر. التطبيقان منفصلان
ويعملان معاً على نفس الجهاز، ومنذ 2.0.0 يبحث كلٌّ منهما عن خليفته ويثبّته لك.
...
- تستخدم التطبيقين معاً؟ يُوصى بسيرفر لكلٍّ منهما — Lite ينظّف السيرفر وSuper
  يحفظ فيه، ونسخة واحدة لا تفعل الأمرين. الدليل يشرح السبب، وسيرفر واحد يكفي
  إن كنت مستخدمه الوحيد.
