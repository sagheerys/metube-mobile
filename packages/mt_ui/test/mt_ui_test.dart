...
void main() {
  ...
  group('MTLocalizations', () {
    ...
    /// dialog
    /// showed two visible backslashes around the playlist name, because the
    /// quote in the arb file was written as an escaped backslash-quote and
    /// JSON unescaped it into a backslash followed by a quote. Neither
    /// `analyze` nor the parity guard catches it: the JSON is valid and the
    /// key is translated in both languages. **Only the eye sees it**, and
    /// this
    /// guard now stands in for the eye.
