...
void main() {
  group('AppVersion.tryParse', () {
    test('it accepts the shapes this project actually releases', () {
    ...
    test('it rejects what cannot be compared rather than guessing', () {
      for (final bad in [
        null,
        '',
        '  ',
    ...
    test('it reads a pre-release and keeps its suffix', () {
  ...
  group('comparison', () {
    test('**the guard**: 2.10.0 is newer than 2.9.0', () {
    ...
    test('ordering across all three levels', () {
      expect(
    ...
    test(
      'a pre-release ranks below the stable release of the same version',
      () {
