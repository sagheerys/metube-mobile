      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            Expanded(
              child: Text(l10n.updateAvailable, style: text.titleMedium),
            ),
          ]),
          ...
          if (release.notes.trim().isNotEmpty) ...[
            ...
            const SizedBox(height: MTSpace.xs),
            // **محدود الارتفاع وقابل للتمرير**: ملاحظات إصدار طويلة كانت
            // تدفع الأزرار خارج الشاشة فلا يبقى فعل مرئي.
            ConstrainedBox(
