...
/// Download notifications in Super (decision 2026-09-06): progress while
/// pulling, completion whose tap opens the app and highlights the item,
/// and errors. A silent channel for progress and another for the result,
/// so the phone does not ring at every percentage.
class DownloadNotifications {
  DownloadNotifications({FlutterLocalNotificationsPlugin? plugin})
    : _plugin = plugin ?? FlutterLocalNotificationsPlugin();

  static const progressChannelId = 'com.yasir.metubesuper.progress';
  static const resultChannelId = 'com.yasir.metubesuper.result';
